...
public class PenguinAgent : Agent
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        else if (collision.transform.CompareTag("baby"))
        {
            ...
            RegurgitateFish();
        } else if (collision.transform.CompareTag("poison"))
        {
            EatPoisonFish(collision.gameObject);
        }
    }
    ...
    private void EatFish(GameObject fishObject)
    {
        ...
        eatenFishNum++;
        if(eatenFishNum >= maxStomach) isFull = true;
    ...
    private void EatPoisonFish(GameObject poisonFishObject)
    {
        penguinArea.RemoveSpecificPoisonFish(poisonFishObject);
        AddReward(-1.2f);
    }
